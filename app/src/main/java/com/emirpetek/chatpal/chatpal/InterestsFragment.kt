...
class InterestsFragment : Fragment() {
    ...
    private fun addTopicDataToList(){
        ...
        interestsTopicList.add(InterestsTopicData("Bilim",R.drawable.icon_science,elementItemScience))
        ...
        interestsTopicList.add(InterestsTopicData("Gezi",R.drawable.icon_travel_bag,elementItemTravel))
