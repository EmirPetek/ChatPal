...
import com.emirpetek.chatpal.chatpal.adapter.MessagesScreenAdapter
import com.emirpetek.chatpal.chatpal.data.ChatData
...
class MessagesScreenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkerIsChattedBefore(
            userKeyMain!!,
            userkeyForAnotherUser, usernameMain!!, usernameForAnotherUser)
