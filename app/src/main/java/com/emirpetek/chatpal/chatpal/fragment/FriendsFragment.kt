...
import com.emirpetek.chatpal.chatpal.FindFriend
import com.emirpetek.chatpal.chatpal.R
import com.emirpetek.chatpal.chatpal.UserCheckCallback
import com.emirpetek.chatpal.chatpal.activity.UserScreenActivity
import com.emirpetek.chatpal.chatpal.adapter.FriendlistAdapter
                    ...
                    if (username.isEmpty()) {
                        ...
                        if (username.equals(usernameMain)){
                            Toast.makeText(requireContext(),
                                R.string.cannot_send_request_yourself, Toast.LENGTH_SHORT).show()
                        }else{
                        ...
                        //    Log.e("friendsfragment ", "login uname " + usernameMain.toString()  )
                            ...
                            userObj.userCheck(username, object : UserCheckCallback {
                                override fun onUserCheckResult(isUserFound: Boolean) {
                                    if (!isUserFound) {
                                        Toast.makeText(requireContext(),
                                            R.string.no_found_user, Toast.LENGTH_SHORT).show()
